                            ...
                            <div class="col-md-12">
                                <div class="card-body">
                                    <div class="col-lg-8">
                                        ...
                                        <form action="<?= base_url('peserta/edit_profile') ?>" method="post" enctype="multipart/form-data">
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="nama_lengkap" autocomplete="off" readonly name="nama_lengkap" value="<?= $user['nama_lengkap']; ?>">
                            ...
                            <div class="col-md-12">
                                <div class="card-body">
                                    <div class="col-lg-8">
                                        ...
                                        <form action="<?= base_url('peserta/ubah_password') ?>" method="post" enctype="multipart/form-data">
                                            <div class="row mb-3">

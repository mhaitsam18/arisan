    ...
    <div class="page">
        <div class="container">
            <div class="content-left">
                ...
                <div class="text">Untuk menggunakan aplikasi, silahkan login terlebih dahulu menggunakan akun yang sudah dibuat oleh petugas.</div>
                <br>
                <br>
            ...
            <div class="content-right">
                ...
                <div class="form">
                    ...
                    <form method="POST" action="<?= base_url('auth/login_peserta') ?>">

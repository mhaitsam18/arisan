                            ...
                            <div class="col-md-12">
                                <div class="card-body">
                                    <div class="col-lg-8">
                                        ...
                                        <form action="<?= base_url('petugas/edit_profile') ?>" method="post" enctype="multipart/form-data">
                                            <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="card-body">
                                    <div class="col-lg-8">
                                        ...
                                        <form action="<?= base_url('petugas/ubah_password') ?>" method="post" enctype="multipart/form-data">
                                            <div class="row mb-3">
